<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/hdfs/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/hdfs/metadata.yaml"
...
The configuration file name for this integration is `go/hdfs.conf`.
...
To troubleshoot issues with the `hfs` collector, run the `go.plugin` with the debug option enabled. The output
