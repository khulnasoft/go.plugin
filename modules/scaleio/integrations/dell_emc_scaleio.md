<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/scaleio/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/scaleio/metadata.yaml"
...
The configuration file name for this integration is `go/scaleio.conf`.
...
sudo ./edit-config go/scaleio.conf
```
#### Options
...
To troubleshoot issues with the `scaleio` collector, run the `go.plugin` with the debug option enabled. The output
