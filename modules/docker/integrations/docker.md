<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/docker/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/docker/metadata.yaml"
...
The configuration file name for this integration is `go/docker.conf`.
...
sudo ./edit-config go/docker.conf
```
#### Options
...
To troubleshoot issues with the `docker` collector, run the `go.plugin` with the debug option enabled. The output
