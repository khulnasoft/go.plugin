<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pihole/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pihole/metadata.yaml"
...
The configuration file name for this integration is `go/pihole.conf`.
...
sudo ./edit-config go/pihole.conf
```
#### Options
...
To troubleshoot issues with the `pihole` collector, run the `go.plugin` with the debug option enabled. The output
