<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginxvts/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginxvts/metadata.yaml"
...
The configuration file name for this integration is `go/nginxvts.conf`.
...
sudo ./edit-config go/nginxvts.conf
```
#### Options
...
To troubleshoot issues with the `nginxvts` collector, run the `go.plugin` with the debug option enabled. The output
