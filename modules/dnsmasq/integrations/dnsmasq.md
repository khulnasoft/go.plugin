<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsmasq/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsmasq/metadata.yaml"
...
The configuration file name for this integration is `go/dnsmasq.conf`.
...
sudo ./edit-config go/dnsmasq.conf
```
#### Options
...
To troubleshoot issues with the `dnsmasq` collector, run the `go.plugin` with the debug option enabled. The output
