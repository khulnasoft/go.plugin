<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/lighttpd/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/lighttpd/metadata.yaml"
...
The configuration file name for this integration is `go/lighttpd.conf`.
...
sudo ./edit-config go/lighttpd.conf
```
#### Options
...
To troubleshoot issues with the `lighttpd` collector, run the `go.plugin` with the debug option enabled. The output
