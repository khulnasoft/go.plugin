<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/coredns/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/coredns/metadata.yaml"
...
The configuration file name for this integration is `go/coredns.conf`.
...
sudo ./edit-config go/coredns.conf
```
#### Options
...
To troubleshoot issues with the `coredns` collector, run the `go.plugin` with the debug option enabled. The output
