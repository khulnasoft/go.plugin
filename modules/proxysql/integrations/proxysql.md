<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/proxysql/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/proxysql/metadata.yaml"
...
The configuration file name for this integration is `go/proxysql.conf`.
...
sudo ./edit-config go/proxysql.conf
```
#### Options
...
To troubleshoot issues with the `proxysql` collector, run the `go.plugin` with the debug option enabled. The output
