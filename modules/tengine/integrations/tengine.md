<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/tengine/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/tengine/metadata.yaml"
...
The configuration file name for this integration is `go/tengine.conf`.
...
sudo ./edit-config go/tengine.conf
```
#### Options
...
To troubleshoot issues with the `tengine` collector, run the `go.plugin` with the debug option enabled. The output
