<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/mysql/integrations/percona_mysql.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/mysql/metadata.yaml"
...
The configuration file name for this integration is `go/mysql.conf`.
...
sudo ./edit-config go/mysql.conf
```
#### Options
...
To troubleshoot issues with the `mysql` collector, run the `go.plugin` with the debug option enabled. The output
