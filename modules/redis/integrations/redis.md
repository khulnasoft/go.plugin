<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/redis/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/redis/metadata.yaml"
sidebar_label: "Redis"
...
The configuration file name for this integration is `go/redis.conf`.
...
sudo ./edit-config go/redis.conf
```
#### Options
...
To troubleshoot issues with the `redis` collector, run the `go.plugin` with the debug option enabled. The output
