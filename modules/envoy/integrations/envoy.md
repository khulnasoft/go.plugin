<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/envoy/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/envoy/metadata.yaml"
sidebar_label: "Envoy"
...
The configuration file name for this integration is `go/envoy.conf`.
...
sudo ./edit-config go/envoy.conf
```
#### Options
...
To troubleshoot issues with the `envoy` collector, run the `go.plugin` with the debug option enabled. The output
