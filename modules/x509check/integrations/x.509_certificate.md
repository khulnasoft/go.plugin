<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/x509check/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/x509check/metadata.yaml"
...
The configuration file name for this integration is `go/x509check.conf`.
...
sudo ./edit-config go/x509check.conf
```
#### Options
...
To troubleshoot issues with the `x509check` collector, run the `go.plugin` with the debug option enabled. The output
