<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/elasticsearch/integrations/elasticsearch.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/elasticsearch/metadata.yaml"
...
The configuration file name for this integration is `go/elasticsearch.conf`.
...
sudo ./edit-config go/elasticsearch.conf
```
#### Options
...
To troubleshoot issues with the `elasticsearch` collector, run the `go.plugin` with the debug option enabled. The output
