<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vsphere/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vsphere/metadata.yaml"
...
The configuration file name for this integration is `go/vsphere.conf`.
...
sudo ./edit-config go/vsphere.conf
```
#### Options
...
To troubleshoot issues with the `vsphere` collector, run the `go.plugin` with the debug option enabled. The output
