<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/traefik/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/traefik/metadata.yaml"
...
The configuration file name for this integration is `go/traefik.conf`.
...
sudo ./edit-config go/traefik.conf
```
#### Options
...
To troubleshoot issues with the `traefik` collector, run the `go.plugin` with the debug option enabled. The output
