<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/cockroachdb/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/cockroachdb/metadata.yaml"
...
The configuration file name for this integration is `go/cockroachdb.conf`.
...
sudo ./edit-config go/cockroachdb.conf
```
#### Options
...
To troubleshoot issues with the `cockroachdb` collector, run the `go.plugin` with the debug option enabled. The output
