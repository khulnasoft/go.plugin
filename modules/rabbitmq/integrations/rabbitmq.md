<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/rabbitmq/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/rabbitmq/metadata.yaml"
...
The configuration file name for this integration is `go/rabbitmq.conf`.
...
sudo ./edit-config go/rabbitmq.conf
```
#### Options
...
To troubleshoot issues with the `rabbitmq` collector, run the `go.plugin` with the debug option enabled. The output
