<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/phpdaemon/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/phpdaemon/metadata.yaml"
...
The configuration file name for this integration is `go/phpdaemon.conf`.
...
sudo ./edit-config go/phpdaemon.conf
```
#### Options
...
To troubleshoot issues with the `phpdaemon` collector, run the `go.plugin` with the debug option enabled. The output
