<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/ntpd/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/ntpd/metadata.yaml"
sidebar_label: "NTPd"
...
The configuration file name for this integration is `go/ntpd.conf`.
...
To troubleshoot issues with the `ntpd` collector, run the `go.plugin` with the debug option enabled. The output
