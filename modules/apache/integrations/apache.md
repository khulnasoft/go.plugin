<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/apache/integrations/apache.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/apache/metadata.yaml"
...
The configuration file name for this integration is `go/apache.conf`.
...
sudo ./edit-config go/apache.conf
```
#### Options
...
To troubleshoot issues with the `apache` collector, run the `go.plugin` with the debug option enabled. The output
