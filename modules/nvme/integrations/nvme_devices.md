<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nvme/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nvme/metadata.yaml"
...
The configuration file name for this integration is `go/nvme.conf`.
...
To troubleshoot issues with the `nvme` collector, run the `go.plugin` with the debug option enabled. The output
