<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/couchbase/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/couchbase/metadata.yaml"
...
The configuration file name for this integration is `go/couchbase.conf`.
...
sudo ./edit-config go/couchbase.conf
```
#### Options
...
To troubleshoot issues with the `couchbase` collector, run the `go.plugin` with the debug option enabled. The output
