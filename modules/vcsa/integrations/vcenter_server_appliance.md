<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vcsa/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vcsa/metadata.yaml"
...
The configuration file name for this integration is `go/vcsa.conf`.
...
To troubleshoot issues with the `vcsa` collector, run the `go.plugin` with the debug option enabled. The output
