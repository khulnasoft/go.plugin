<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/wireguard/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/wireguard/metadata.yaml"
...
The configuration file name for this integration is `go/wireguard.conf`.
...
sudo ./edit-config go/wireguard.conf
```
#### Options
...
To troubleshoot issues with the `wireguard` collector, run the `go.plugin` with the debug option enabled. The output
