<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/fluentd/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/fluentd/metadata.yaml"
...
The configuration file name for this integration is `go/fluentd.conf`.
...
sudo ./edit-config go/fluentd.conf
```
#### Options
...
To troubleshoot issues with the `fluentd` collector, run the `go.plugin` with the debug option enabled. The output
