<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/httpcheck/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/httpcheck/metadata.yaml"
...
The configuration file name for this integration is `go/httpcheck.conf`.
...
sudo ./edit-config go/httpcheck.conf
```
#### Options
...
| headers_match.value | The [pattern](https://github.com/khulnasoft/go.plugin/tree/master/pkg/matcher#supported-format) to match against the value of the specified header. |  | no |
...
jobs:
  - name: local
    ...
    headers:
      Host: localhost:8080
      User-Agent: khulnasoft/go.plugin
      Accept: */*
...
Example configurations with `header_match`. See the value [pattern](https://github.com/khulnasoft/go.plugin/tree/master/pkg/matcher#supported-format) syntax.
...
To troubleshoot issues with the `httpcheck` collector, run the `go.plugin` with the debug option enabled. The output
