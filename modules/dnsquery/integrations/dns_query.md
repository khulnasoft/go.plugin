<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsquery/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsquery/metadata.yaml"
...
The configuration file name for this integration is `go/dns_query.conf`.
...
sudo ./edit-config go/dns_query.conf
```
#### Options
...
To troubleshoot issues with the `dns_query` collector, run the `go.plugin` with the debug option enabled. The output
