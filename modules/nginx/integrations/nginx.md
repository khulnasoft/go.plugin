<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginx/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginx/metadata.yaml"
sidebar_label: "NGINX"
...
The configuration file name for this integration is `go/nginx.conf`.
...
sudo ./edit-config go/nginx.conf
```
#### Options
...
To troubleshoot issues with the `nginx` collector, run the `go.plugin` with the debug option enabled. The output
