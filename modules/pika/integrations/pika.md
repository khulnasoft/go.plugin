<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pika/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pika/metadata.yaml"
sidebar_label: "Pika"
...
The configuration file name for this integration is `go/pika.conf`.
...
To troubleshoot issues with the `pika` collector, run the `go.plugin` with the debug option enabled. The output
