<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/solr/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/solr/metadata.yaml"
sidebar_label: "Solr"
...
The configuration file name for this integration is `go/solr.conf`.
...
To troubleshoot issues with the `solr` collector, run the `go.plugin` with the debug option enabled. The output
