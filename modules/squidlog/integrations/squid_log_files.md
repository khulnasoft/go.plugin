<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/squidlog/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/squidlog/metadata.yaml"
...
The configuration file name for this integration is `go/squidlog.conf`.
...
sudo ./edit-config go/squidlog.conf
```
#### Options
...
To troubleshoot issues with the `squidlog` collector, run the `go.plugin` with the debug option enabled. The output
