<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/unbound/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/unbound/metadata.yaml"
...
The configuration file name for this integration is `go/unbound.conf`.
...
sudo ./edit-config go/unbound.conf
```
#### Options
...
To troubleshoot issues with the `unbound` collector, run the `go.plugin` with the debug option enabled. The output
