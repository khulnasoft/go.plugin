<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/cassandra/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/cassandra/metadata.yaml"
...
- Add
  the [jmx_exporter.yaml](https://raw.githubusercontent.com/khulnasoft/go.plugin/master/modules/cassandra/jmx_exporter.yaml)
...
The configuration file name for this integration is `go/cassandra.conf`.
...
sudo ./edit-config go/cassandra.conf
```
#### Options
...
To troubleshoot issues with the `cassandra` collector, run the `go.plugin` with the debug option enabled. The output
