<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/k8s_state/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/k8s_state/metadata.yaml"
...
The configuration file name for this integration is `go/k8s_state.conf`.
...
sudo ./edit-config go/k8s_state.conf
```
#### Options
...
To troubleshoot issues with the `k8s_state` collector, run the `go.plugin` with the debug option enabled. The output
