<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/mongodb/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/mongodb/metadata.yaml"
...
The configuration file name for this integration is `go/mongodb.conf`.
...
sudo ./edit-config go/mongodb.conf
```
#### Options
...
To troubleshoot issues with the `mongodb` collector, run the `go.plugin` with the debug option enabled. The output
