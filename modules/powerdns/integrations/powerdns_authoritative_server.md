<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/powerdns/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/powerdns/metadata.yaml"
...
The configuration file name for this integration is `go/powerdns.conf`.
...
sudo ./edit-config go/powerdns.conf
```
#### Options
...
To troubleshoot issues with the `powerdns` collector, run the `go.plugin` with the debug option enabled. The output
