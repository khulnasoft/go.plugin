<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsdist/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/dnsdist/metadata.yaml"
...
The configuration file name for this integration is `go/dnsdist.conf`.
...
sudo ./edit-config go/dnsdist.conf
```
#### Options
...
To troubleshoot issues with the `dnsdist` collector, run the `go.plugin` with the debug option enabled. The output
