<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/logstash/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/logstash/metadata.yaml"
...
The configuration file name for this integration is `go/logstatsh.conf`.
...
sudo ./edit-config go/logstatsh.conf
```
#### Options
...
To troubleshoot issues with the `logstash` collector, run the `go.plugin` with the debug option enabled. The output
