<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/couchdb/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/couchdb/metadata.yaml"
...
The configuration file name for this integration is `go/couchdb.conf`.
...
sudo ./edit-config go/couchdb.conf
```
#### Options
...
To troubleshoot issues with the `couchdb` collector, run the `go.plugin` with the debug option enabled. The output
