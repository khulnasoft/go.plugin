<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vernemq/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/vernemq/metadata.yaml"
...
The configuration file name for this integration is `go/vernemq.conf`.
...
sudo ./edit-config go/vernemq.conf
```
#### Options
...
To troubleshoot issues with the `vernemq` collector, run the `go.plugin` with the debug option enabled. The output
