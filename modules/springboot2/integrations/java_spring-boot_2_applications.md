<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/springboot2/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/springboot2/metadata.yaml"
...
The configuration file name for this integration is `go/springboot2.conf`.
...
sudo ./edit-config go/springboot2.conf
```
#### Options
...
To troubleshoot issues with the `springboot2` collector, run the `go.plugin` with the debug option enabled. The output
