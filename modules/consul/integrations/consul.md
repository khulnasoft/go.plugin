<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/consul/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/consul/metadata.yaml"
...
The configuration file name for this integration is `go/consul.conf`.
...
sudo ./edit-config go/consul.conf
```
#### Options
...
To troubleshoot issues with the `consul` collector, run the `go.plugin` with the debug option enabled. The output
