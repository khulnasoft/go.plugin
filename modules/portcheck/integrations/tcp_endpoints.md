<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/portcheck/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/portcheck/metadata.yaml"
...
The configuration file name for this integration is `go/portcheck.conf`.
...
sudo ./edit-config go/portcheck.conf
```
#### Options
...
To troubleshoot issues with the `portcheck` collector, run the `go.plugin` with the debug option enabled. The output
