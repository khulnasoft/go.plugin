<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/windows/integrations/active_directory.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/windows/metadata.yaml"
...
The configuration file name for this integration is `go/windows.conf`.
...
sudo ./edit-config go/windows.conf
```
#### Options
...
To troubleshoot issues with the `windows` collector, run the `go.plugin` with the debug option enabled. The output
