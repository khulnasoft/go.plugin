<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/zookeeper/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/zookeeper/metadata.yaml"
...
The configuration file name for this integration is `go/zookeeper.conf`.
...
sudo ./edit-config go/zookeeper.conf
```
#### Options
...
To troubleshoot issues with the `zookeeper` collector, run the `go.plugin` with the debug option enabled. The output
