<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/supervisord/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/supervisord/metadata.yaml"
...
The configuration file name for this integration is `go/supervisord.conf`.
...
sudo ./edit-config go/supervisord.conf
```
#### Options
...
To troubleshoot issues with the `supervisord` collector, run the `go.plugin` with the debug option enabled. The output
