<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/activemq/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/activemq/metadata.yaml"
...
The configuration file name for this integration is `go/activemq.conf`.
...
sudo ./edit-config go/activemq.conf
```
#### Options
...
To troubleshoot issues with the `activemq` collector, run the `go.plugin` with the debug option enabled. The output
