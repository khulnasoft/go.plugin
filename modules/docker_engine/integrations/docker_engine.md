<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/docker_engine/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/docker_engine/metadata.yaml"
...
The configuration file name for this integration is `go/docker_engine.conf`.
...
sudo ./edit-config go/docker_engine.conf
```
#### Options
...
To troubleshoot issues with the `docker_engine` collector, run the `go.plugin` with the debug option enabled. The output
