<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/upsd/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/upsd/metadata.yaml"
...
The configuration file name for this integration is `go/upsd.conf`.
...
To troubleshoot issues with the `upsd` collector, run the `go.plugin` with the debug option enabled. The output
