<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pulsar/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/pulsar/metadata.yaml"
...
The configuration file name for this integration is `go/pulsar.conf`.
...
sudo ./edit-config go/pulsar.conf
```
#### Options
...
To troubleshoot issues with the `pulsar` collector, run the `go.plugin` with the debug option enabled. The output
