<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginxplus/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/nginxplus/metadata.yaml"
...
The configuration file name for this integration is `go/nginxplus.conf`.
...
sudo ./edit-config go/nginxplus.conf
```
#### Options
...
To troubleshoot issues with the `nginxplus` collector, run the `go.plugin` with the debug option enabled. The output
