<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/geth/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/geth/metadata.yaml"
...
The configuration file name for this integration is `go/geth.conf`.
...
To troubleshoot issues with the `geth` collector, run the `go.plugin` with the debug option enabled. The output
