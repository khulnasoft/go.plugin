<!--startmeta
custom_edit_url: "https://github.com/khulnasoft/go.plugin/edit/master/modules/phpfpm/README.md"
meta_yaml: "https://github.com/khulnasoft/go.plugin/edit/master/modules/phpfpm/metadata.yaml"
...
The configuration file name for this integration is `go/phpfpm.conf`.
...
sudo ./edit-config go/phpfpm.conf
```
#### Options
...
To troubleshoot issues with the `phpfpm` collector, run the `go.plugin` with the debug option enabled. The output
